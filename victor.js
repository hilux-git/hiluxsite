...
}else if(userText.includes("you") && userText.includes("bad") || userText.includes("are terrible") || userText.includes("shit") || userText.includes("the worst")){
...
}else if(userText.includes("i ") && userText.includes("miss") || userText.includes("am sad") || userText.includes("had a bad day") || userText.includes("want love") || userText.includes("loved") || userText.includes("depressed") || userText.includes("sad") || userText.includes("lost") || userText.includes("bad") || userText.includes("shit")){
